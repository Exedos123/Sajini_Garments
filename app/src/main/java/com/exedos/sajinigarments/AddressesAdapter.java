...
import static com.exedos.sajinigarments.MyAccountFragment.MANAGE_ADDRESS;
import static com.exedos.sajinigarments.MyAddressActivity.refreshItem;
...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.Viewholder> {
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            fullname = itemView.findViewById(R.id.address_item_layout_name);
            address = itemView.findViewById(R.id.address_item_layout_address);
            pincode = itemView.findViewById(R.id.address_item_layout_pincode);
