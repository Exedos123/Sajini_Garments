    ...
    class Viewholder extends RecyclerView.ViewHolder{
        ...
        private void setData (int resource, int rating, String title, String deliveredDate){
             ...
             if(deliveredDate.equals("Cancelled")) {
                 orderIndicator.setImageTintList(ColorStateList.valueOf(itemView.getContext().getResources().getColor(R.color.design_default_color_primary)));
             }else{
                 orderIndicator.setImageTintList(ColorStateList.valueOf(itemView.getContext().getResources().getColor(R.color.design_default_color_on_secondary)));
             }
